    ...
    function proxyrequest() {
      ...
      myConnector.getSchema = function (schemaCallback) {
        var cols = [
          ...
          { id : "company", alias : "Practice", columnRole : "dimension", dataType : tableau.dataTypeEnum.string },
                ...
                success: function(resp) {
                  ...
                  for (var i = 0, len = feat.length; i < len; i++) {
                            tableData.push({
                                ...
                                "company" : feat[i].values.data[8].$,
                                "CustomerName": feat[i].values.data[9].$,
                                "DNIS": feat[i].values.data[10].$,
                                "CallTime": feat[i].values.data[11].$,
                                "BillTime": feat[i].values.data[12].$,
                                "Cost": feat[i].values.data[13].$,
                                "IVRTime": feat[i].values.data[14].$,
                                "QueueWaitTime": feat[i].values.data[15].$,
                                "RingTime": feat[i].values.data[16].$,
                                "TalkTime": feat[i].values.data[17].$,
                                "HoldTime": feat[i].values.data[18].$,
                                "ParkTime": feat[i].values.data[19].$,
                                "AfterCallWorkTime": feat[i].values.data[20].$,
                                "Transfers": feat[i].values.data[21].$,
                                "Conferences": feat[i].values.data[22].$,
                                "Holds": feat[i].values.data[23].$
                          });
